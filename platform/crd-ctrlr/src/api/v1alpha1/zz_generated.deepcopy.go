...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in SdewanpurposeRole) DeepCopyInto(out *SdewanpurposeRole) {
	{
		in := &in
		*out = make(SdewanpurposeRole, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SdewanpurposeRole.
func (in SdewanpurposeRole) DeepCopy() SdewanpurposeRole {
	if in == nil {
		return nil
	}
	out := new(SdewanpurposeRole)
	in.DeepCopyInto(out)
	return *out
}
